# maneater's conformist overlay, merged with conformist.lib.presets.{eng,eng-go}
...
{ pkgs, ... }:
{
  ...
  linters.eng-versioning.key = "MANEATER_VERSION";
  ...
  # out-links; zz-fixtures/manpages/man*/ are generated byte-stable fixtures.
  settings.excludes = [
    "*.md"
    "build/**"
    ".tmp/**"
    "result"
    "result-*"
    "zz-fixtures/manpages/man1/**"
    "zz-fixtures/manpages/man5/**"
  ];
}
